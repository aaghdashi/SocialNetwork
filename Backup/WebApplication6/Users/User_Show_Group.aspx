...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="mainContent">
        <div style="font-family: tahoma, arial; font-size: small; vertical-align: middle;
            ...
            <asp:ImageButton ID="ImageButton_Make_Group" runat="server" ImageUrl="~/Users/images/Make_Group.png"
                AlternateText="ایجاد گروه" OnClick="ImageButton_Make_Group_Click" />
            <asp:ImageButton ID="ImageButton_Show_Group" runat="server" ImageUrl="~/Users/images/users (2).png"
                    ...
                    <tr>
                        ...
                        <td align="right" dir="rtl" style="font-family: tahoma, arial; font-size: small;
                            ...
                            <asp:DropDownList ID="DropDownList_Group_type" runat="server" Font-Names="Tahoma"
                                Width="300px">
                                <asp:ListItem Value="0">کل گروه های موجود </asp:ListItem>
                        ...
                        <asp:View ID="View_Exist_Group" runat="server">
                            <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 750px;">
                                <div style="max-width: 750px; width: 750px; direction: rtl; position: relative; text-align: center;
                                    ...
                                    <asp:Repeater ID="Repeater_Exist_Group_Section1" runat="server" 
                                        DataSourceID="SqlDataSource_Exist_Group_Section1" 
                                        onitemdatabound="Repeater_Exist_Group_Section1_ItemDataBound">
                                        <ItemTemplate>
...
">
                            ...
                            <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 750px;">
                                <div style="max-width: 750px; width: 750px; direction: rtl; position: relative; text-align: center;
                                    ...
                                    <asp:Repeater ID="Repeater_Maked_Group_By_me_Section1" runat="server" 
                                        DataSourceID="SqlDataSource_Maked_Group_By_me_Section1" 
                                        onitemdatabound="Repeater_Maked_Group_By_me_Section1_ItemDataBound">
                                        <ItemTemplate>
                                            <table style="max-width: 750px" dir="rtl" align="center">
                                                <tr>
                                                    <td>
                        ...
                        <asp:View ID="View_Joined_Group" runat="server">
                            <asp:SqlDataSource ID="SqlDataSource_Joined_Group_Section1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                SelectCommand="SELECT  Group_tbl.Name_Group, Group_tbl.Topic_Group, Member_Group_tbl.Date_member, Group_tbl.Discreption_Group, Group_tbl.Pic_Group, Group_tbl.ID FROM Member_Group_tbl INNER JOIN Group_tbl ON Member_Group_tbl.ID_Group=Group_tbl.ID
...
">
                            ...
                            <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 750px;">
                                <div style="max-width: 750px; width: 750px; direction: rtl; position: relative; text-align: center;
                                    top: 0px; right: 0px; float: right;" align="center" dir="rtl">
                                    <asp:Repeater ID="Repeater_Joined_Group_Section1" runat="server" 
                                        DataSourceID="SqlDataSource_Joined_Group_Section1" 
                                        onitemdatabound="Repeater_Joined_Group_Section1_ItemDataBound">
                                        <ItemTemplate>
                                            <table style="max-width: 750px" dir="rtl" align="center">
                                                <tr>
                                                    <td>
                    ...
                    <table style="width: 100%;" dir="rtl">
                        ...
                        <tr>
                            ...
                            <td style="border-style: 1; border-width: thin; border-color: #FFFFFF;" colspan="3">
                                <asp:TextBox ID="RadTextBox_NameGroup" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" style="border-style: 1; border-width: thin; border-color: #FFFFFF;">
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="border-style: 1; border-width: thin; border-color: #FFFFFF;">
                                <asp:TextBox ID="TextBox_Email" runat="server" AutoCompleteType="Email" Width="350px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border-style: 1; border-width: thin; border-color: #FFFFFF;">
                                <asp:TextBox ID="TextBox_Confirm_password" runat="server" TextMode="Password"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="TextBox_Confirm_password"
                                    ...
                                    Font-Names="Tahoma" Font-Size="X-Small" ValidationGroup="a"></asp:CompareValidator>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                        ...
                        <tr>
                            <td align="center" colspan="4">
                                ...
                                <asp:Button ID="Button_Create_Group" runat="server" Font-Names="Tahoma" OnClick="Button_Create_Group_Click"
                                    Text="ایجاد گروه" ValidationGroup="a" />
