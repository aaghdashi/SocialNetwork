        ...
        protected void GridView_Users_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (_id != (int)GridView_Users.SelectedValue)
            {
                ...
                if (!DR.HasRows)
                {
                    ...
                    try
                    {
                        new_command.CommandText = "INSERT INTO Request_Friend_tbl(Request_User_ID,Response_User_ID,Response_Date) VALUES ('" + _id + "','" + GridView_Users.SelectedValue + "','" + DateTime.Now.Date.ToShortDateString() + "')";
                        new_command.ExecuteNonQuery();
