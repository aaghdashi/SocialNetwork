...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="mainContent">
        ...
        <table style="width: 750px;">
            <tr>
                <td align="center" style="width: 750px; height: 50px">
                    <asp:ImageButton ID="Img_btn_TextFile_User" runat="server" ImageUrl="~/Users/images/Files-text.png"
                        AlternateText="آپلود فایل متنی" Height="48px" Width="48px" 
                    ...
                    <asp:ImageButton ID="Img_btn_control_panel" runat="server" 
                        ...
                        Height="48px" Width="48px" OnClick="Img_btn_Download_Click" />
                    <br />
            ...
            <tr>
                <td style="font-family: tahoma, arial; font-size: small; font-weight: normal; font-style: normal;
                    vertical-align: top; text-align: left; width: 750px; height: 350px" align="center">
                        ...
                        <asp:View ID="View_TextFile_User" runat="server">
                            <div class="ContentUserPage">
                                <table align="center">
                                    ...
                                    <tr>
                                        <td align="right" width="120" style="border: thin solid #999966; font-size: x-small;">
                                            عنوان مربوط به فایل:
                                        </td>
                        ...
                        <asp:View ID="View_Picture_User" runat="server">
                            <div class="ContentUserPage">
                                <table align="center">
                                    <tr>
                                        <td colspan="4" align="right" dir="rtl">
                                            &nbsp; &nbsp; <span style="color: red">*</span> <span style="color: white">کاربر گرامی
                                    ...
                                    <tr>
                                        <td align="right" style="border: thin solid #999966; font-size: x-small;" width="200">
                                            عنوان عکس :
                                        </td>
                                        <td align="left" style="border: thin solid #999966;">
                                            &nbsp;<asp:TextBox ID="TextBox_Topic_pic" runat="server"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="right" style="border: thin solid #999966;" width="200">
                                        </td>
                                        <td align="right">
                                            &nbsp;
                                        </td>
...
" 
                                    ...
                                    UpdateCommand="UPDATE Uploads_Pic_User_tbl SET Topic_Pic = @Topic_Pic, Discreption_Pic = @Discreption_Pic, Date_Upload = @Date_Upload WHERE (ID = @id)">
                                    <DeleteParameters>
                                    ...
                                    <UpdateParameters>
                                        ...
                                        <asp:Parameter DbType="Date" Name="Date_Upload" />
                                        <asp:Parameter Name="id" />
                                    </UpdateParameters>
                                </asp:SqlDataSource>
                                <hr style="background-color: #2C3E5B" />
                        ...
                        <asp:View ID="View_Movie_User" runat="server">
                            <div class="ContentUserPage">
                                <table align="center">
                                    ...
                                    <tr>
                                        <td align="right" dir="ltr" style="border: thin solid #999966; font-size: x-small;">
                                            عنوان فیلم:
                                        </td>
                        ...
                        <asp:View ID="View_Upload_Files" runat="server">
                            <br />
                            <div style="font-family: tahoma, arial; width: 735px; height: 500px; background-color: #95A0B2;
                                top: 0px; float: left; text-align: center; vertical-align: middle; font-size: medium;
                                left: 0px; right: 0px;" class="File_Content">
                                    ...
                                    <tr>
                                        <td style="font-family: tahoma, arial; vertical-align: top; text-align: right;" 
                                            ...
                                            <dl>
                                                <dt dir="rtl" 
                                                    ...
                                                    style="font-family: tahoma; font-size: x-small; color: #006699; text-align: right; vertical-align: top;">
                                                    - قوانین مربوط به آپلود فایل های متنی :</dt>
                                            </dl>
                                        ...
                                        <td align="right" style="font-family: tahoma, arial; vertical-align: top">
                                            ...
                                            <p dir="rtl" style="font-size: x-small">
                                                ...
                                                MP4 و یا سایر فرمت های ویدیویی باشد.</p>
                                            <p dir="rtl" style="font-size: x-small">
                                                <span style="color: red">*</span> در صورتی که سایز فایل شما بالا می باشد می 
                                                توانید آن را توسط نرم افزار های فشرده سازی ،فشرده نمایید و با پسوند Zipو یا Rar 
                                                آپلود کنید.</p>
                                        ...
                                        <td dir="rtl" style="font-family: tahoma, arial; font-size: x-small; text-align: right;
                                            vertical-align: top;" width="250">
                                            <dl>
                        ...
                        <asp:View ID="View_Download_Files" runat="server">
                           ...
                           <div class="ContentUserPage" align="center" dir="rtl">
                                ...
                                <asp:GridView ID="GridView_Textfile_User0" runat="server" 
                                    ...
                                    DataKeyNames="ID" Width="750px" EmptyDataText="هیچ فایلی آپلود نشده است." 
...
WHERE ID_USER=@id" 
                                    UpdateCommand="UPDATE Uploads_Textfile_User_tbl SET Topic_Textfile = @topic, Discreption_Textfile = @Description, Path_Textfile = @path, Date_Upload = @date WHERE (ID = @ID)">
                                    <DeleteParameters>
                                        <asp:Parameter Name="ID" />
                                    </DeleteParameters>
                                    <SelectParameters>
                                ...
                                «فایل های تصویری»<asp:GridView ID="GridView_Picture_User" runat="server" AllowPaging="True" 
                                    ...
                                    PageSize="8" EmptyDataText="هیچ فایل تصویری آپلود نشده است." Width="750px" 
                            ...
                            <ItemTemplate>
                                ...
                                <asp:GridView ID="GridView_Movie_User" runat="server" AllowPaging="True" 
                                    ...
                                    GridLines="None" PageSize="8" DataKeyNames="ID" Width="750px" 
                            ...
                            <ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                    ...
                                    UpdateCommand="UPDATE Uploads_Movie_User_tbl SET Topic_Movie = @topic, Discreption_Movie = @description WHERE (ID = @id)">
                                    <DeleteParameters>
                                        <asp:Parameter Name="id" />
                                    </DeleteParameters>
                                    <SelectParameters>
