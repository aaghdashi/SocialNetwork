        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="font-family: tahoma, arial; font-size: small; vertical-align: middle;
                    ...
                    <asp:ImageButton ID="Img_btn_Show_Friends_User" runat="server" ImageUrl="~/Users/images/Friend.png"
                        OnClick="Img_btn_Show_Friends_User_Click" />
                    <asp:ImageButton ID="Img_btn_Edit_Friends_User" runat="server" ImageUrl="~/Users/images/manegement_f.png"
                    ...
                    <asp:View ID="View_Show_Friends" runat="server">
                        <div class="File_Content" dir="rtl">
                            ...
                            <asp:GridView ID="GridView_Show_Friend" runat="server" AutoGenerateColumns="False"
                                ...
                                EmptyDataText="شما با هیچ کاربری دوست نیستید." Width="750px" OnRowDataBound="GridView_Show_Friend_RowDataBound">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <Columns>
                                    <asp:ImageField DataImageUrlField="User_pic" NullImageUrl="~/Users/images/no_image.png">
                                        <ControlStyle CssClass="widthpic" Height="100px" Width="80px" />
                                    </asp:ImageField>
                    ...
                    <asp:View ID="View_Edit_Friends" runat="server">
                        <div class="File_Content" dir="rtl">
                            ...
                            <asp:GridView ID="GridView_Edit_Friend" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                EmptyDataText="شما با هیچ کاربری دوست نیستید." Width="750px" 
