...
namespace WebApplication6.Groups
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        public void _Show_Info()
        {
            ...
            _Select_info = "SELECT Name_Group,Topic_Group, Discreption_Group,Email,Admin_Name,Security_Question,Security_Answer FROM Group_tbl WHERE ID_Creator= '" + _id + "'";
        ...
        protected void btn_Edit_info_Group_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                new_command.CommandText = "UPDATE Group_tbl SET Name_Group='" + txt_name_Group.Text + "',Topic_Group='" + TextBox_Topic_Group.Text + "', Discreption_Group='" + txt_Discreption_Group.Text + "',Email='" + txt_Email_Group.Text + "',Admin_Name='" + txt_name_Account_Group.Text + "'  WHERE ID_Creator='" + _id + "'";
        ...
        protected void btn_save_Group_pic_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload_pic_Edit_Group.HasFile)
            {
                ...
                try
                {
                    ...
                    new_connection.Open();
                    new_command.Connection = new_connection;
                    new_command.CommandText = "UPDATE Group_tbl SET Pic_Group= '" + _pic_path + "' WHERE ID_Creator='" + _id + "'";
                    new_command.ExecuteNonQuery();
        ...
        {
            string _id_member_group = "";
            _id_member_group = (string)GridView_MemberShip.SelectedValue;           

                new_connection.ConnectionString = New_User.ConnectionString;
                new_connection.Open();
                new_command.Connection = new_connection;
                new_command.CommandText = "DELETE FROM Member_Group_tbl WHERE ID='" + _id_member_group + "'";
                new_command.ExecuteNonQuery();
                Literal_Member.Text = "لغو عضویت با موفقیت انجام شد.";            
        }
