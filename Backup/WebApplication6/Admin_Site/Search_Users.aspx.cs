...
namespace WebApplication6.Admin_Site
{
    public partial class Search_Users : System.Web.UI.Page
    {
        ...
        protected void Button_Search_Click(object sender, EventArgs e)
        {
            ...
            _Criteria[5] = TextBox_Date_Member1.Text !="" ? " AND User_tbl.Date_m >= '" + persian_English.C_Date_fa_to_en(TextBox_Date_Member1.Text) + "'"  : "";
            _Criteria[6] = TextBox_Date_Member2.Text != "" ? " AND User_tbl.Date_m <= '" + persian_English.C_Date_fa_to_en(TextBox_Date_Member2.Text) + "'" : "";
