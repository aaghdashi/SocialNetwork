<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Users_master.Master" AutoEventWireup="true"
    CodeBehind="Users_Friends.aspx.cs" Inherits="WebApplication6.Users.WebForm5" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div style="font-family: tahoma, arial; font-size: small; vertical-align: middle;
                    ...
                    <asp:ImageButton ID="Img_btn_Show_Friends_User" runat="server" ImageUrl="~/Users/images/Friend.png" ToolTip="نمایش لیست دوستان"
                        OnClick="Img_btn_Show_Friends_User_Click" />
                    <asp:ImageButton ID="Img_btn_Edit_Friends_User" runat="server" ImageUrl="~/Users/images/manegement_f.png" ToolTip="ویرایش لیست دوستان "
                        OnClick="Img_btn_Edit_Friends_User_Click" />
                </div>
                        ...
                        <div class="File_Content" dir="rtl">
                            ...
                            <asp:GridView ID="GridView_Show_Friend" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="E_mail" HeaderText="آدرس پست الکترونیک" SortExpression="E_mail" />
                    ...
                    <asp:View ID="View_Edit_Friends" runat="server">
                        <div class="File_Content" dir="rtl">
                            ...
                            <asp:GridView ID="GridView_Edit_Friend" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                ...
                                EmptyDataText="شما با هیچ کاربری دوست نیستید." Width="874px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True"
                                        SortExpression="ID" Visible="False" />
                                    <asp:CommandField DeleteText="لغو دوستی" ShowDeleteButton="True">
                                        <ControlStyle Font-Names="Tahoma" Font-Size="X-Small" />
                                    </asp:CommandField>
                                </Columns>
                                <EditRowStyle BackColor="#999999" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource_Manage_Friend" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                DeleteCommand="DELETE FROM Request_Friend_tbl WHERE (Response_User_ID = @ID) OR (Request_User_ID = @ID)"
                                SelectCommand="SELECT DISTINCT User_tbl.Name, User_tbl.Family, User_tbl.Account_name, User_tbl.Birth_date, User_tbl.E_mail, User_tbl.User_pic, User_tbl.ID FROM User_tbl INNER JOIN Request_Friend_tbl ON Request_Friend_tbl.Response_User_ID = User_tbl.ID  WHERE (Request_Friend_tbl.Flag='true' AND Request_Friend_tbl.Request_User_ID = @id) AND (Request_Friend_tbl.Block='false')
UNION
SELECT DISTINCT User_tbl.Name, User_tbl.Family, User_tbl.Account_name, User_tbl.Birth_date, User_tbl.E_mail, User_tbl.User_pic, User_tbl.ID FROM User_tbl INNER JOIN Request_Friend_tbl ON Request_Friend_tbl.Request_User_ID = User_tbl.ID  WHERE (Request_Friend_tbl.Flag='true' AND Request_Friend_tbl.Response_User_ID = @id) AND (Request_Friend_tbl.Block='false')">
                                <DeleteParameters>
