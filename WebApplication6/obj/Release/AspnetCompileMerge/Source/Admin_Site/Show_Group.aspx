        ...
        <asp:MultiView ID="MultiView_Group" runat="server" ActiveViewIndex="0">
            <asp:View ID="View_Topic" runat="server">
                ...
                <asp:Panel ID="Panel_Show_Word" runat="server" Style="color: #FFFFFF">
                    <asp:DataList ID="DataList3" runat="server" DataSourceID="SqlDataSource_Topic" RepeatColumns="5">
                        <HeaderTemplate>
                    ...
                    <asp:GridView ID="GridView_Topic" runat="server" AutoGenerateColumns="False" 
                        ...
                        ForeColor="#333333" GridLines="None" Width="200px" HorizontalAlign="Center">
            ...
            <asp:View ID="View_Show_Group" runat="server">
                <asp:SqlDataSource ID="SqlDataSource_Show_Group" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                    ...
                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource_Show_Group" RepeatColumns="3" OnItemDataBound="DataList1_ItemDataBound">
                         <HeaderTemplate>
                            <p align="center" dir="rtl" style="color: #FFFFFF">
...
WHERE Group_tbl.ID=@id   ORDER BY ID  ASC
  ">
                    ...
                    <asp:DataList ID="DataList2" runat="server" DataSourceID="SqlDataSource_Show_Member_Group" RepeatColumns="3" OnItemDataBound="DataList2_ItemDataBound">
                         <ItemTemplate>
                            <table width="280px" dir="rtl" align="center">
                                <tr>
                                    <td>
