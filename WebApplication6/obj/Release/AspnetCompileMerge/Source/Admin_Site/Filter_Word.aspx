                ...
                <asp:View ID="View_Show_Word" runat="server">
                    <div dir="rtl" style="text-align: center">
                        ...
                        <hr style="background-color: #2C3E5B; height: -12px;" />
                            ...
                            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource_Show_Word" CellSpacing="4" RepeatColumns="4" Width="874px">
                                 <HeaderTemplate>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                        ...
                                        EmptyDataText="هیچ کلمه ای درج نشده است." Width="874px">
