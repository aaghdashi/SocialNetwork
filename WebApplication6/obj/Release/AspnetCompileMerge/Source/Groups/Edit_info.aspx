...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="MainContent">
        <div style="font-family: tahoma, arial; font-size: small; vertical-align: middle;
            ...
            <asp:ImageButton ID="Img_btn_Edit_Info_Group" runat="server" ImageUrl="~/Groups/images/edit_info.png" ToolTip="ویرایش اطلاعات"
                OnClick="Img_btn_Edit_Info_Group_Click" />
            <asp:ImageButton ID="Img_btn_Edit_Members_Group" runat="server" ImageUrl="~/Groups/images/member.png" ToolTip="مدیریت اعضا"
                OnClick="Img_btn_Edit_Members_Group_Click" Style="width: 48px" />
            <asp:ImageButton ID="Img_btn_Image_group" runat="server" ImageUrl="~/Groups/images/pictures.png" ToolTip="ویرایش عکس"
                OnClick="Img_btn_Image_group_Click" />
        </div>
        <asp:MultiView ID="MultiView_Edit" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="View_Edit_Info_Group" runat="server">
                <table style="width: 874px; height: 500px; font-family: tahoma, arial; font-size: small;
                    ...
                    <tr>
                        ...
                        <td style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: right;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;" colspan="3">
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right" colspan="4" style="font-family: tahoma, arial; font-size: small;
                            ...
                            <asp:TextBox ID="txt_Email_Group" runat="server" Width="350px" AutoCompleteType="Email" TextMode="Email"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: right;
                    ...
                    <tr>
                        <td align="left" style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: right;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;">وضعیت گروه:</td>
                        <td align="right" colspan="2" style="font-family: tahoma, arial; font-size: small;
                            font-style: normal; vertical-align: middle; text-align: right; border-bottom-style: dotted;
                            border-bottom-width: thin; height: 40px; border-bottom-color: #FFFFFF;">
                            <asp:CheckBox ID="CheckBox_Active" runat="server" Text="فعال" />
                        </td>
                        <td align="right" colspan="2" style="font-family: tahoma, arial; font-size: small;
                            font-style: normal; vertical-align: middle; text-align: right; border-bottom-style: dotted;
                            border-bottom-width: thin; height: 40px; border-bottom-color: #FFFFFF;">
                            <asp:CheckBox ID="CheckBox_Archive" runat="server" Text="آرشیو" />
                        </td>
                    </tr>
                    <tr>
                        <td align="left" colspan="5" style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: right;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                    ...
                    <tr>
                        <td align="left" colspan="3" style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: right;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;">توجه در صورت حذف گروه کلیه اطلاعات مربوطه نیز حذف می شود.</td>
                        <td align="right" colspan="2" style="font-family: tahoma, arial; font-size: small;
                            font-style: normal; vertical-align: middle; text-align: right; border-bottom-style: dotted;
                            border-bottom-width: thin; height: 40px; border-bottom-color: #FFFFFF;">
                            <asp:Button ID="Button_DeleteGroup" runat="server" Font-Names="Tahoma" OnClick="Button_DeleteGroup_Click" Text="حذف گروه" />
                        </td>
                    </tr>
                    <tr>
                        <td style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: center;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;" colspan="5">
                    ...
                    <tr>
                        <td style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: center;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;" align="center" colspan="5">
                            &nbsp;
                    ...
                    <tr>
                        <td style="font-family: tahoma, arial; font-size: small; font-style: normal; text-align: center;
                            height: 40px; vertical-align: middle; border-bottom-style: dotted; border-bottom-width: thin;
                            border-bottom-color: #FFFFFF;" colspan="5" align="center">
                            <hr style="background-color: #2C3E5B" />
            ...
            <asp:View ID="View_Edit_Members_Group" runat="server">
                <div align="center" dir="rtl">
                    ...
                    <asp:GridView ID="GridView_MemberShip" runat="server" AutoGenerateColumns="False"
                        ...
                        GridLines="None" Width="874px" OnRowDataBound="GridView_MemberShip_RowDataBound"
                        OnSelectedIndexChanged="GridView_MemberShip_SelectedIndexChanged">
                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                        <Columns>
                            <asp:BoundField DataField="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" Visible="False" />
