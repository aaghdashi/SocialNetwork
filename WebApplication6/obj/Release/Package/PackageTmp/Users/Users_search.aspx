        ...
        <ContentTemplate>
            <div class="mainContent">
                <div style="font-family: tahoma, arial; font-size: small; vertical-align: middle; text-align: center; width: 874px; height: 60px; top: 0px; right: 0px">
                    <asp:ImageButton ID="Img_btn_Search_Group" runat="server" AlternateText="برای جستجوی گروه مورد نظر خود کلیک کنید" ToolTip="برای جستجوی گروه مورد نظر خود کلیک کنید"
                        Height="48px" ImageUrl="~/Users/images/users.png" OnClick="Img_btn_Search_Group_Click"
                        Width="48px" />
                    <asp:ImageButton ID="Img_btn_Search_User" runat="server" AlternateText="برای جستجوی کاربر مورد نظر خود کلیک کنید"  ToolTip="برای جستجوی کاربر مورد نظر خود کلیک کنید"
                        Height="48px" ImageUrl="~/Users/images/user.png" OnClick="Img_btn_Search_User_Click"
                        Width="48px" />
                    <asp:ImageButton ID="ImageButton_search_Post" runat="server" AlternateText="برای جستجوی پست مورد نظر خود کلیک کنید" ToolTip="برای جستجوی پست مورد نظر خود کلیک کنید"
                        Height="48px" ImageUrl="~/Users/images/Comment.png" 
                        Width="48px" OnClick="ImageButton_search_Post_Click" />
                </div>
            ...
            <tr>
                <td align="center" style="width: 874px; height: 50px">
                    <asp:ImageButton ID="Img_btn_Post" runat="server" ImageUrl="~/Users/images/Post.png" ToolTip="پست ها"
                        AlternateText="پست ها" Height="48px" Width="48px" OnClick="Img_btn_Post_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    

                    <asp:ImageButton ID="Img_btn_user" runat="server" ImageUrl="~/Users/images/user.png" ToolTip="کاربران"
                        AlternateText="کاربران" Height="48px" Width="48px" OnClick="Img_btn_user_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <asp:ImageButton ID="Img_btn_Group" runat="server" ImageUrl="~/Users/images/Group List.png" ToolTip="گروه ها"
                        AlternateText="گروه ها" Height="48px" Width="48px" OnClick="Img_btn_Group_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;

                    <asp:ImageButton ID="Img_btn_Textfile" runat="server" ImageUrl="~/Users/images/Files-text.png" ToolTip="فایل های متنی"
                        AlternateText="فایل های متنی" Height="48px" Width="48px" OnClick="Img_btn_Textfile_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;

                     <asp:ImageButton ID="Img_btn_Video" runat="server" ImageUrl="~/Users/images/Movie.png" ToolTip="فایل های ویدیویی"
                        AlternateText="فایل های ویدیویی" Height="48px" Width="48px" OnClick="Img_btn_Video_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:ImageButton ID="Img_btn_Pic" runat="server" ImageUrl="~/Users/images/gallery.png" ToolTip="تصاویر"
                        AlternateText="تصاویر" Height="48px" Width="48px" OnClick="Img_btn_Pic_Click" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <asp:MultiView ID="MultiView_Result" runat="server" ActiveViewIndex="0">
                                ...
                                <asp:View ID="View_post" runat="server">
                                    <asp:Panel ID="Panel_Search" runat="server" Height="600px"
                                        ...
                                        <asp:Repeater ID="Repeater_Post" runat="server" OnItemDataBound="Repeater_Post_ItemDataBound">
                                            <HeaderTemplate>
                                                <p dir="rtl" align="right" style="font-family: tahoma, arial; font-size: small; color: #FF0000; vertical-align: middle; ">
                                                    «پست ها»
                                                </p>
                                                <hr style="background-color: #2C3E5B" />
                                            </HeaderTemplate>
                                                ...
                                                <div>
                                                    <p dir="rtl" style="text-align: right">
                                                        <span style="font-size: x-small; color: #666666;">تاریخ:<asp:Label ID="Label_Date"
                                                            runat="server" Text='<%#Eval("DT_Create")%>'></asp:Label></span>
                                                    </p>
                                                </div>
                                                <div dir="rtl" style="text-align: right">
                                                    <span style="font-size: small; color: #666666;">نام کاربر:</span><%#Eval("name_Account")%></div>
                                                <div dir="rtl" style="text-align: right">
                                                    <span style="font-size: small; color: #666666;">عنوان پست:</span><%#Eval("Title")%></div>
                                                <div dir="rtl" style="text-align: right">
                                                   <span style="font-size: small; color: #666666;">متن پست:</span><%#Eval("Body")%></div>
                                    ...
                                    <asp:Repeater ID="Repeater_User" runat="server" OnItemDataBound="Repeater_User_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <table style="max-width: 750px" dir="rtl" align="center">
                                                    ...
                                                    <tr>
                                                        <td>نام:<asp:Label ID="Label4" runat="server" Text='<%#Eval("Name") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>نام کاربری:<asp:Label ID="Label2" runat="server" Text='<%#Eval("Account_name") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>تاریخ عضویت:<asp:Label ID="Label_member_Date" runat="server" Text='<%#Eval("Date_m") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>جنسیت :<asp:Label ID="Label1" runat="server" Text='<%#Eval("Gender") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>توضیحات :<asp:Label ID="Label3" runat="server" Text='<%#Eval("Discreption_User") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>علایق :<asp:Label ID="Label5" runat="server" Text='<%#Eval("Favorites_user") %>'></asp:Label>
                                                        </td>
                                                    </tr>
                                ...
                                <asp:View ID="View_group" runat="server">
                                     <asp:Repeater ID="Repeater_Group" runat="server" OnItemDataBound="Repeater_Group_ItemDataBound">
                                            ...
                                            <ItemTemplate>
                                                <table style="max-width: 874px" dir="rtl" align="center">
                                                    <tr>
                                                        <td>
                                ...
                                <asp:View ID="View_text" runat="server">
                                ...
                                <asp:View ID="View_pic" runat="server">
                    ...
                    <asp:View ID="View_Search_User" runat="server">
                        ...
                        <p dir="rtl">
                            ...
                            وارد کردن اطلاعات خواسته شده ، کاربر مورد نظر خود را بیابید.
                        </p>
                        <br />
                        <hr style="background-color: #2C3E5B" />
                        <div align="center" dir="rtl" class="File_Content" style="background-image: url('http://localhost:1185/Users/images/Search_users.png'); background-repeat: no-repeat">
                            <table style="width: 100%;" dir="rtl">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txt_Name" runat="server" Width="150px"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txt_Family" runat="server" Width="150px"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">نام کاربری :
                                    </td>
                                    <td>
                                        <telerik:RadTextBox ID="txt_Account_Name" runat="server" Width="150px"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">محل زندگی:
                                    </td>
                                    <td>
                                        <telerik:RadTextBox ID="txt_City_live" runat="server" Width="150px"></telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">جنسیت :
                    ...
                    <asp:View ID="View_Search_Group" runat="server">
                        <table style="width: 100%;" dir="rtl">
                            ...
                            <tr>
                                <td align="left">نام گروه :&nbsp;
                                </td>
                                <td>
                                    <telerik:RadTextBox ID="txt_Name_Group" runat="server" Width="150px"></telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">&nbsp;موضوع گروه:
                                </td>
                                <td>
                    ...
                    <asp:View ID="View_SearchPost" runat="server">
                        <br />
                         <p dir="rtl">
                            <span style="color: red">*</span> کاربر گرامی شما در این بخش از سایت می توانید با
                            وارد کردن اطلاعات خواسته شده ، پست مورد نظر خود را بیابید.
                        </p>
                        <br />
                        <hr style="background-color: #2C3E5B" />
                        <div align="center" dir="rtl" class="File_Content" style="background-image: url('http://localhost:1185/Users/images/Search_users.png'); background-repeat: no-repeat">
                            <table style="width: 100%;" dir="rtl">
                                ...
                                <tr>
                                    <td align="left">عنوان پست:
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TextBox_TopicPost" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">متن پست:
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TextBox_Memo" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">بازه زمانی :
                                    </td>
                                    <td>
                                        <asp:TextBox ID="TextBox_time1" runat="server" TextMode="Date"></asp:TextBox>
                                        &nbsp;تا
                                        <asp:TextBox ID="TextBox_time2" runat="server" TextMode="Date"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        <asp:ImageButton ID="ImageButton_SearchPost" runat="server" Height="30px" ImageUrl="~/images/search.png"
                                            Width="60px" OnClick="ImageButton_SearchPost_Click" />
                                        <br />
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                            <hr style="background-color: #2C3E5B" />
                                        <asp:Repeater ID="Repeater_SearchPost" runat="server" OnItemDataBound="Repeater_SearchPost_ItemDataBound" >
                                            <ItemTemplate>
                                                <div class="Post">
                                                    <div>
                                                    <p dir="rtl" style="text-align: right">
                                                ...
                                                <div style="text-align: right">
                                                    <span style="font-size:small; color: #666666;">نام کاربر:</span><%#Eval("name_Account")%><span/></div>
                                                <div dir="rtl" style="text-align: right">
                                                    <span style="font-size: small; color: #666666;">عنوان پست:</span><%#Eval("Title")%></div>
                                                <div dir="rtl" style="text-align: right">
                                                    <span style="font-size: small; color: #666666;">متن پست:</span><%#Eval("Body")%></div>
