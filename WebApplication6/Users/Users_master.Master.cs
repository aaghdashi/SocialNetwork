...
namespace WebApplication6.Users
{
    public partial class Users_master : System.Web.UI.MasterPage
    {
        ...
        {
            Response.Redirect("User_Chat.aspx");
        }
        ...
        protected void ImageButton_Request_Click(object sender, ImageClickEventArgs e)
        {
        ...
        {
            Response.Redirect("User_Census.aspx");
        }

        protected void ImageButton_Block_Click(object sender, ImageClickEventArgs e)
        {
            Response.Redirect("User_BlockList.aspx");
        }
