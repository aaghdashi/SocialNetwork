        ...
        <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 874px;
            ...
            <div style="max-width: 874px; width: 874px; direction: rtl; position: relative; text-align: center;
                ...
                <asp:Panel ID="Panel_Gap" runat="server" Direction="RightToLeft" Height="300px" 
                    ...
                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource_Gap_Section1" RepeatColumns="4" CellPadding="10" OnItemDataBound="DataList1_ItemDataBound">
                         <ItemTemplate>
                        <table width="200px">
                            <tr>
                                <td>
                                    <asp:Image ID="Image_user" CssClass="imagep" runat="server" ImageUrl='<%#Eval("User_pic")%>' AlternateText='<%#Eval("name_user") %>'/>
                                </td>
                            </tr>
                            <tr>
                                <td>
  ...
  ">
        ...
        <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 874px;
            ...
            <asp:Repeater ID="Repeater_Gap" runat="server" 
                ...
                <ItemTemplate>
                    <table style="width: 874px; height: 150px;" dir="rtl">
                        <tr>
                            <td rowspan="2" align="right">
                                <table style="width: 200px; font-size: x-small">
                                    <tr>
                                        <td rowspan="3" style="text-align: right" width="90px">
                                            <asp:Image ID="Image_Gap" CssClass="imagep" runat="server" ImageUrl='<%#Eval("User_pic")%>' />
                                        </td>
                                        <td style="text-align: right">
                                            <span class="style3" style="text-align: right">نام:</span><asp:Label ID="Label_Comment_user_name"
                                                runat="server" Text='<%#Eval("USERNAME")%>' Font-Names="Tahoma" Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right">
                                            <span class="style3">نام کاربری:</span><asp:Label ID="Label_Comment_user_accountname"
                                                runat="server" Text='<%#Eval("Account_name")%>' Font-Names="Tahoma" Font-Size="Small"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="style3" dir="rtl" style="text-align: left; max-width: 140px; font-size: small;">
                                    تاریخ:</span>
                            </td>
                            <td dir="rtl" align="right" style="text-align: right; max-width: 460px" width="460px">
            ...
            <div style="font-family: tahoma, arial; font-size: small; vertical-align: top; width: 874px;
                position: relative;">
                <table style="width: 874px; max-width: 874px; font-size:small;">
                    <tr>
                    ...
                    <tr>
                        <td align="right" dir="rtl" width="650" >
                            &nbsp; &nbsp;
