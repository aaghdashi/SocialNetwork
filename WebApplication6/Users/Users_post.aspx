                ...
                <asp:MultiView ID="MultiView_Post" runat="server" ActiveViewIndex="0">
                    <asp:View ID="View_Show_post" runat="server">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div>
                                        <p dir="rtl" style="text-align: right">
                                            <span style="font-size: small; color: #666666;">تاریخ:</span><asp:Label ID="lbl_date"
                                    ...
                                    <div dir="rtl" style="text-align: right">
                                        <pre><span style="font-size: small; color: #666666;">عنوان پست:</span><%#Eval("Title")%></pre>
                                       <br />
                                    </div>
                                    <div dir="rtl" style="text-align: right">
                                        <pre><span style="font-size: small; color: #666666;">متن پست:</span><%#Eval("Body")%></pre>
                                        <br />
                                    </div>
                        ...
                        <div class="mainContent_message">
                            <table width="874px" style="max-width: 874px; max-height: 250px;">
                                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            Width="874px" OnRowDataBound="GridView1_RowDataBound">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource_Post" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                            ...
                            UpdateCommand="UPDATE Post_Users_tbl SET Title =@Title, Body =@Body,DT_Create=GETDATE() WHERE ID=@ID">
                            <DeleteParameters>
