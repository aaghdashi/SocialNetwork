...
namespace WebApplication6.Users
{
    ...
    public partial class User_Edit_Info : System.Web.UI.Page
    {
        ...
        public void _Show_Info()
        {
            ...
            TextBox_BirthDate.Text= English_Persian.C_Date_en_to_fa(_DS.Tables[0].Rows[0][4].ToString());
        ...
        protected void Button_Editpic_Click(object sender, EventArgs e)
        {
            SqlCommand new_command = new SqlCommand();
            string _filename;
            var _extentionfile = "";
